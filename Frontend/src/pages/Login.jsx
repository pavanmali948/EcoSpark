    ...
    try {
      ...
      if (response.data && response.data.success) {
        ...
        const userData = {
          ...
          licenseNo:
            d.licenseNo ??
            (currentRole === "pump_admin" ? identifier : undefined),
          pumpName: d.pumpName,
        ...
        >
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Self-service password reset is not enabled yet. Use the option
              that matches your role:
            </p>
            <ul className="text-sm text-gray-700 space-y-2 list-disc pl-5 mb-6">
              <li>
                <strong className="text-sky-700">Customers</strong> — contact
                support or register again with a different email if you no
                longer have access.
              </li>
              <li>
                <strong className="text-amber-700">Workers</strong> — ask your
                pump administrator to set a new password.
              </li>
              <li>
                <strong className="text-emerald-700">Pump admins</strong> —
                contact the super administrator.
              </li>
              {/* <li>
                <strong className="text-rose-700">Super admins</strong> — use
                your organization&apos;s database or deployment recovery
                process.
              </li> */}
            </ul>
            <button
